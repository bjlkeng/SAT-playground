...
pub(crate) struct SolverStats {
    ...
    /// kitten solve calls spent by the conflict-cadence sweep (throughput)
    pub(crate) sweep_solves: u64,
    /// wall nanoseconds spent inside sweep prove_facts (throughput)
    pub(crate) sweep_prove_nanos: u64,
    ...
    pub(crate) bsr_skip_occurrence_limit: u64,
    ...
    pub(crate) partial_occurrence_index: u64,
    pub(crate) gc_skipped_large: u64,
    pub(crate) gc_inplace_compactions: u64,
    pub(crate) lucky_skipped_large: u64,
...
pub(crate) fn json_stats_line(ctx: &StatsJsonContext<'_>) -> String {
    ...
    json.string("solver", "12-kissat-inprocessing");
    json.string(
        "solver_git_sha",
    ...
    json.u64("sweep_solves", ctx.stats.sweep_solves);
    json.u64("sweep_prove_nanos", ctx.stats.sweep_prove_nanos);
...
pub(crate) fn trace_full_line(stats: &SolverStats, _timings: &RunTimings) -> String {
    format!(
        concat!(
            ...
            "chrono_attempts={} chrono_backtracks={} non_chrono_backtracks={} chrono_rejected_not_asserting={} chrono_rejected_delta_small={} chrono_skipped_levels={} ",
        ...
        stats.chrono_rejected_delta_small,
