# Contextual Bandit / RL Search Controller for Solver 12 — Design Plan

**Status:** plan, rev 3 — second review + round-2 deep research integrated · **Date:** 2026-06-11 · **Target:** `solver/12-kissat-inprocessing`
...
decisions at **restart / rephase / reduce / mode boundaries** inside solver 12, in three phases:
...
## 2. What solver 12 decides today (decision-point map)
...
`solver/12-kissat-inprocessing/src/`.
...
which is exactly what we are doing to solver 12.
